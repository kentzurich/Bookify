...
internal class CacheService : ICacheService
{
    ...
    // may issue ka dito pag nag retrieve ng GetBookingQuery from cache , 
    //'JsonSerializer.Deserialize<T>(bytes)' threw an exception of type 'System.NotSupportedException'
